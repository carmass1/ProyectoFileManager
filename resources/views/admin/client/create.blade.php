...
<div class="row">
	<div class="col-md-10 offset-md-1 bg-white card">
		...
		<form id="Form_cliente" action=" {{route('admin.client.store')}} " method="POST" class="was-validated m-5" autocomplete="off" >
			@csrf 
			<div class="form-row ">                   
				...
				<div class="panel panel-default">
					<div class="card-body">                                
						<div class="col text-center  mb-3" >
							<button class="btn btn-outline-info " type="button" href="#" id="btn_add" ><i class="fa fa-plus-circle  fa-1x"></i>  AGREGAR CONTACTOS </button> 
						</div>
						<div class="inner" id="data_contacto">
							...
							<div class="form-row row_contact">                      
								...
								<div class="col-md-1">
									<button class="btn btn-outline-info quitar_fill " type="button" href="#"><i class="fa fa-trash  fa-1x"></i> </button>
								</div>
							</div> 
						</div>                              
					</div>
			...
			<div class="col text-center mt-4" >
				...
				<button type="submit" id="btnGuardar" class="btn btn-outline-success "><i class='fa fa-plus-circle'></i>   REGISTRAR</button>
			</div>                  
		</form>
	</div>
</div>
			...
			$("#btn_add").click(function()
			{
				...
				var fila=`
					<div class="form-row row_contact">
						...
						<div class="col-md-1">
						<button class="btn btn-outline-info delete-fill quitar_fill" type="button" href="#"><i class="fa fa-trash  fa-1x"></i> </button> 
						</div>    
					</div>
				`;  
				$('.inner').append(fila); 
